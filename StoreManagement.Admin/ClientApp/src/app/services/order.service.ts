...
export class OrderService {
  ...
  // getorderFullById(id: any): Observable<any> {
  //     return this.http.get(`${this.baseUrl}/GetorderFullById/${id}`);
  // }
  ...
  // editorderFull(id: any, order: any) {
  //     return this.http.put(`${this.baseUrl}/UpdateorderFull/${id}`, order);
  // }
